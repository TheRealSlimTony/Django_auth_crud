...
urlpatterns = [
    ...
    path(
        "pointing/create_game_session",
        pointerviews.create_game_session,
        name="game_session",
    ),
    path(
        "pointing/join_session/<int:game_session_id>/",
        pointerviews.join_session,
        name="join_session",
    ),
    path(
        "pointing/game_session/<int:game_session_id>/card_selection/<int:user_id>/",
        pointerviews.card_selection,
        name="select_cards",
    ),
